  ...
  return (
    <div className="card card-info-page">
      <div className="custom-body-text">
        <p>
          Olá, servidor, seja bem vindo ao formumário eletrônico de abertura de
          chamados.
        </p>
        ...
        <p className="for-desktop badge bg-primary text-wrap">
          Selecione no menu ao lado, uma categoria de serviço para que possamos
          iniciar o seu atendimento.
        </p>
        <p>
        ...
        <table className="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <th scope="row">LGPD</th>
              <td>
                Solicitações de maiores informações sobre nossa Política de
                Proteção aos Dados e/ou deligências ligadas a Lei Federal n. 13.709/2018.
              </td>
            </tr>
          </tbody>
        </table>
